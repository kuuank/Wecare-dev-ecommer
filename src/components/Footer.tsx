        ...
        <div className="box-border flex relative flex-col shrink-0 mx-auto mt-5 w-full max-w-[1200px]">
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4">
            ...
            <h2 className="text-lg font-semibold text-white mb-5">
              ...
              <p className="text-white pb-3">Trụ sở: Lô B39 KCN Phú Tài, Trần Quang Diệu, Quy Nhơn, Bình Định</p>
              <p className="text-white pb-3">Email: supportwecare@gmail.com</p>
              <p className="text-white pb-3">Phone: +84 378 339 009</p>
            </div>
            {/* Column 2 */}
            <div className="flex flex-col">
              <h2 className="text-lg font-semibold text-white mb-5">Ngành hàng</h2>
            ...
            {/* Column 3 */}
            <div className="flex flex-col">
              <h2 className="text-lg font-semibold text-white mb-5">Chính sách</h2>
            ...
            <div className="flex flex-col">
              ...
              <p className="text-white pb-3">Cung cấp giải pháp cung ứng toàn diện về vật tư, nguyên vật liệu, phụ kiện, phụ trợ cho các nhà máy, ngành công nghiệp.</p>
            </div>
          </div>
        </div>
      </section>
